...
ax.set_xlabel("per-strain sequencing depth"); ax.set_title("Detection vs depth (C. acnes strain)")
ax.legend(loc="center left", fontsize=8); ax.grid(alpha=0.3, axis="x")
ax.axvspan(0.08, 1.0, color="orange", alpha=0.07)
ax.text(0.28, 0.5, "sparse 2b markers\nlose power < ~1×", fontsize=8, color="#cc7000", ha="center")
