# Depth-sensitivity: strain2bRAD vs StrainScan (the <1× question)

**Question (user):** at <1× depth for a strain, is strain2bRAD *more* sensitive than StrainScan?
...
depth strain2bRAD runs out of observed markers first.

## Experiment
Single C. acnes strain **GCF_009737125** (present in *both* tools' DBs), simulated shotgun
reads (150 bp, error-free) at 0.1× / 0.5× / 1× / 5× genome coverage. strain2bRAD profiled
...
| depth | strain2bRAD (floor 10) | strain2bRAD (floor 3) | StrainScan |
|---|---|---|---|
| 0.1× | miss | miss | miss |
...
**Detection-onset depth: StrainScan ≈ 0.5×, strain2bRAD ≈ 1× (permissive) to ≈ 5× (default).**
Even with a permissive floor of 3, strain2bRAD cannot detect at 0.5× — fewer than 3 of the
...
- The correct, defensible claim: *strain2bRAD matches StrainScan at **sufficient depth
